...
static float
varn(x, k0, k1, k2, kt, xmn, var, m, mn)
	double *x, var;
	int k0, k1, k2, kt, m, *mn;
	float xmn;
{
	double dx1, dx2, v;
...
static void
mkdbr(l1, l2, isgn, lyr, nph, kph, fac)
	int l1, l2, isgn, lyr, nph, kph;
	double *fac;
{
/*
...
static void
mkrbr(l1, isgn, lyr, nph, kph, fac)
	int l1, isgn, lyr, nph, kph;
	double *fac;
{
...
static void
mkcbr(l1, l2, isgn, lyr, nph, kph, fac)
	int l1, l2, isgn, lyr, nph, kph;
	double *fac;
{
