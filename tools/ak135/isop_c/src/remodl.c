 ...
 */
static void
rough(dr, nr, ncr, modnam)
	float dr;
	int *nr, *ncr;
	char *modnam;
{
	extern void emdld(), emdlv();
	static float rd[30];
 ...
 */
static void
finrng(xg, nph, n, p0, p1, x0, x1, xtol, nr)
	float xg, p0, p1, x0, x1, xtol;
	int nph, n, *nr;
{
	int j, m;
